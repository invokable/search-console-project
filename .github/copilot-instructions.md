...
### Copilot coding agent Environment Restrictions
- **Critical**: The Copilot coding agent firewall causes errors when connecting to `www.googleapis.com`
- This affects Google API calls and should be ignored in Copilot coding agent environment
- The production GitHub Actions environment has no such restrictions
- Use mock data or skip API calls when testing in Copilot coding agent
